...
* - {py:obj}`validate_conf_py_values <chartbook.validation.validate_conf_py_values>`
  - ```{autodoc2-docstring} chartbook.validation.validate_conf_py_values
    :summary:
    ```
* - {py:obj}`validate_source_files <chartbook.validation.validate_source_files>`
  - ```{autodoc2-docstring} chartbook.validation.validate_source_files
    :summary:
    ```
````
...
:canonical: chartbook.validation.validate_source_files

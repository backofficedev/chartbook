...
````{py:function} generate_chart_docs(chart_id, pipeline_id, pipeline_manifest, docs_build_dir=DOCS_BUILD_DIR, pipeline_base_dir=BASE_DIR, pipeline_theme='pipeline', docs_src_dir=DOCS_SRC_DIR, enable_data_download=False)
...
````{py:function} generate_dataframe_docs(dataframe_id, pipeline_id, pipeline_manifest, docs_build_dir=DOCS_BUILD_DIR, pipeline_base_dir=BASE_DIR, pipeline_theme='pipeline', docs_src_dir=DOCS_SRC_DIR, size_threshold=50, enable_data_download=False)
...
````{py:function} generate_pipeline_docs(pipeline_id, pipeline_manifest, pipeline_base_dir=BASE_DIR, docs_build_dir=DOCS_BUILD_DIR, pipeline_theme='pipeline', docs_src_dir=DOCS_SRC_DIR, size_threshold=50, enable_data_download=False)
